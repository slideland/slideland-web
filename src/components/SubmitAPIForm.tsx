...
export default function SubmitAPIForm() {
    ...
    return (
        <Container maxWidth="md" sx={{paddingBottom: 10}}>
            <SuccessAlert isOpen={success} setOpen={setSuccess} text="Your model is uploaded! It will be evaluated continuously, starting today." /> 
            <ErrorAlert isOpen={error} setOpen={setError} text="Something went wrong with the upload. Check your input and try again." /> 
            <h1>Submit model</h1>
            <Typography sx={{ fontSize: 14, marginTop: 1 }} color="text.secondary">
            You can upload your own model and see how it compares to the models available currently. 
            To do so you only need to provide a name of your model and a url to which a GET request can be made. 
            The response of the request should be JSON in the following format:
            </Typography>
